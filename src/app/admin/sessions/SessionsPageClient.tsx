...
export function SessionsPageClient() {
  ...
  if (isLoggingSession) {
    return (
      <div className='w-full max-w-350 mx-auto space-y-6 px-4 lg:px-10 pb-6'>
        <button
          type='button'
        ...
        <div>
          <h1 className='text-2xl font-bold text-muted-foreground'>Log session</h1>
          <p className='mb-8 text-sm text-muted'>
            Add the session details to review, track, and manage sessions on FitCall.
          </p>
        </div>
