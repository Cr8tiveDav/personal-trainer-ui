    ...
    <section className="relative w-full overflow-hidden bg-[#fcfcfc] py-16 md:py-24">
      <div className="container relative mx-auto px-4">
        ...
        <div className="relative mx-auto mt-16 max-w-6xl">
          ...
          <button className="swiper-button-next-custom absolute -right-2 top-1/2 z-20 flex h-10 w-10 -translate-y-1/2 items-center justify-center rounded-full border border-slate-100 bg-white shadow-m
