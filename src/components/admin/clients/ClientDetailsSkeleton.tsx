    ...
    <div className='w-full max-w-[1400px] mx-auto space-y-6 px-4 pb-6'>
      ...
      <div className='flex flex-col gap-6 lg:flex-row'>
        <div className='relative flex-1 rounded-2xl border border-gray-100 bg-white shadow-sm'>
          ...
          <Skeleton className='absolute left-6 top-[112px] h-32 w-32 rounded-full border-4 border-white' />
          <div className='space-y-2 rounded-b-2xl px-6 pb-5 pl-[180px] pt-20'>
            <Skeleton className='h-4 w-48' />
            <Skeleton className='h-4 w-56' />
          </div>
        </div>
        <div className='w-full rounded-2xl border border-gray-100 bg-white p-6 shadow-sm lg:w-[280px]'>
