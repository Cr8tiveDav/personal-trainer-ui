...
const TRAINERS = [
  'Marcus Reed · Strength & Conditioning',
  'Olivia Stone · Yoga & Mobility',
  'Daniel Cruz · HIIT & Cardio',
  'Hana Sato · Pilates',
  'Noah Bennett · Endurance Coaching',
  'Aisha Smith · Weight Loss & Nutrition',
  'Jubril K. · Strength Training',
  'Murphy E. · Functional Fitness',
]
