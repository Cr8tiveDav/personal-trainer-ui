...
const GotoTop = () => {
  ...
  return hideToTop ? undefined : (
    <div
      ...
      onClick={handleTop}
      className={cn(
        'fixed bottom-12 right-2 z-9999 mx-auto flex max-w-360 select-none items-center rounded border border-primary bg-primary/90 text-2xl text-white backdrop-blur-xl transition-all duration-1000 ac
        scrollY > 1000
