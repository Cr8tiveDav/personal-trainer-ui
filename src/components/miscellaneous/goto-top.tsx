...
const GotoTop = () => {
  ...
  return hideToTop ? undefined : (
    <div
      ...
      onClick={handleTop}
      className={cn(
        'fixed bottom-12 right-2 z-[9999] mx-auto flex max-w-[1440px] select-none items-center rounded border border-primary bg-primary/90 text-2xl text-white backdrop-blur-xl transition-all duration-
        scrollY > 1000
